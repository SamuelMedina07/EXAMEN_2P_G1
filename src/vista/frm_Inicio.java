...
public class frm_Inicio extends javax.swing.JFrame {
   ...
   public void iniciarBarra(frm_login frmLogin){
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/ythlogoPNG (Custom).png"))); // NOI18N
        jPanel1.add(jLabel1);
        jLabel1.setBounds(10, 10, 180, 130);
        ...
        jPanel1.add(barra);
        barra.setBounds(20, 170, 170, 32);

        lblTitulo.setForeground(new java.awt.Color(0, 153, 0));
        jPanel1.add(lblTitulo);
        lblTitulo.setBounds(70, 130, 100, 30);

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 210, 250));
